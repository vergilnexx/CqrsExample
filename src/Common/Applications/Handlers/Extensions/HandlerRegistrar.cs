...
namespace Meta.Common.Applications.Handlers.Extensions
{
    /// <summary>
    ...
    public static class HandlerRegistrar
    {
        ...
        /// <summary>
        /// Регистрирует обработчиков запросов.
        /// </summary>
        /// <param name="services">Коллекция сервисов.</param>
        /// <param name="assembly">Данные сборки.</param>
        /// <returns>Коллекция сервисов.</returns>
        ...
        /// <summary>
        /// Регистрирует обработчиков диагностики.
        /// </summary>
        /// <param name="services">Коллекция сервисов.</param>
        /// <param name="assembly">Данные сборки.</param>
        /// <returns>Коллекция сервисов.</returns>
        ...
        /// <summary>
        /// Регистрирует обработчиков событий.
        /// </summary>
        /// <param name="services">Коллекция сервисов.</param>
        /// <param name="assembly">Данные сборки.</param>
        /// <returns>Коллекция сервисов.</returns>

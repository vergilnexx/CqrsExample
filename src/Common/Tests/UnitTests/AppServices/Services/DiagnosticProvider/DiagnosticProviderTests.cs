...
using DiagnosticProviderClass = Meta.Common.Applications.AppServices.Contexts.Common.Services.DiagnosticProvider.DiagnosticProvider;

namespace Meta.Common.Tests.UnitTests.AppServices.Services.DiagnosticProvider
{
    /// <summary>
